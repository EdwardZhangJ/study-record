...
/* harmony export */   "pipeToWebWritable": () => (/* binding */ pipeToWebWritable),
/* harmony export */   "renderToNodeStream": () => (/* binding */ renderToNodeStream),
/* harmony export */   "renderToSimpleStream": () => (/* binding */ renderToSimpleStream),
...
/* harmony export */   "ssrGetDirectiveProps": () => (/* binding */ ssrGetDirectiveProps),
/* harmony export */   "ssrGetDynamicModelProps": () => (/* binding */ ssrGetDynamicModelProps),
/* harmony export */   "ssrIncludeBooleanAttr": () => (/* reexport safe */ _vue_shared__WEBPACK_IMPORTED_MODULE_1__.includeBooleanAttr),
/* harmony export */   "ssrInterpolate": () => (/* binding */ ssrInterpolate),
/* harmony export */   "ssrLooseContain": () => (/* binding */ ssrLooseContain),
/* harmony export */   "ssrLooseEqual": () => (/* binding */ ssrLooseEqual),
/* harmony export */   "ssrRenderAttr": () => (/* binding */ ssrRenderAttr),
/* harmony export */   "ssrRenderAttrs": () => (/* binding */ ssrRenderAttrs),
/* harmony export */   "ssrRenderClass": () => (/* binding */ ssrRenderClass),
/* harmony export */   "ssrRenderComponent": () => (/* binding */ ssrRenderComponent),
/* harmony export */   "ssrRenderDynamicAttr": () => (/* binding */ ssrRenderDynamicAttr),
/* harmony export */   "ssrRenderDynamicModel": () => (/* binding */ ssrRenderDynamicModel),
/* harmony export */   "ssrRenderList": () => (/* binding */ ssrRenderList),
/* harmony export */   "ssrRenderSlot": () => (/* binding */ ssrRenderSlot),
/* harmony export */   "ssrRenderSlotInner": () => (/* binding */ ssrRenderSlotInner),
/* harmony export */   "ssrRenderStyle": () => (/* binding */ ssrRenderStyle),
/* harmony export */   "ssrRenderSuspense": () => (/* binding */ ssrRenderSuspense),
/* harmony export */   "ssrRenderTeleport": () => (/* binding */ ssrRenderTeleport),
/* harmony export */   "ssrRenderVNode": () => (/* binding */ renderVNode)
/* harmony export */ });
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! vue */ "./node_modules/vue/index.mjs");
/* harmony import */ var _vue_shared__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @vue/shared */ "./node_modules/@vue/shared/dist/shared.esm-bundler.js");
var _ErrorTypeStrings;
...
var shouldIgnoreProp = (0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.makeMap)(",key,ref,innerHTML,textContent,ref_key,ref_for");

function ssrRenderAttrs(props, tag) {
  var ret = '';

  for (var key in props) {
    if (shouldIgnoreProp(key) || (0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isOn)(key) || tag === 'textarea' && key === 'value') {
      continue;
    }
...
function ssrRenderDynamicAttr(key, value, tag) {
  ...
  var attrKey = tag && tag.indexOf('-') > 0 ? key // preserve raw name on custom elements
  : _vue_shared__WEBPACK_IMPORTED_MODULE_1__.propsToAttrMap[key] || key.toLowerCase();

  if ((0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isBooleanAttr)(attrKey)) {
    return (0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.includeBooleanAttr)(value) ? " ".concat(attrKey) : "";
  } else if ((0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isSSRSafeAttrName)(attrKey)) {
    return value === '' ? " ".concat(attrKey) : " ".concat(attrKey, "=\"").concat((0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.escapeHtml)(value), "\"");
  } else {
...
function ssrRenderAttr(key, value) {
  ...
  return " ".concat(key, "=\"").concat((0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.escapeHtml)(value), "\"");
}
...
function ssrRenderClass(raw) {
  return (0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.escapeHtml)((0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.normalizeClass)(raw));
}
...
function ssrRenderStyle(raw) {
  ...
  if ((0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isString)(raw)) {
    return (0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.escapeHtml)(raw);
  }

  var styles = (0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.normalizeStyle)(raw);
  return (0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.escapeHtml)((0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.stringifyStyle)(styles));
}
...
function ssrRenderTeleport(parentPush, contentRenderFn, target, disabled, parentComponent) {
  ...
  var context = parentComponent.appContext.provides[vue__WEBPACK_IMPORTED_MODULE_0__.ssrContextKey];
  var teleportBuffers = context.__teleportBuffers || (context.__teleportBuffers = {});
  var targetBuffer = teleportBuffers[target] || (teleportBuffers[target] = []); // record current index of the target buffer to handle nested teleports
...
var createComponentInstance = vue__WEBPACK_IMPORTED_MODULE_0__.ssrUtils.createComponentInstance,
    setCurrentRenderingInstance = vue__WEBPACK_IMPORTED_MODULE_0__.ssrUtils.setCurrentRenderingInstance,
    setupComponent = vue__WEBPACK_IMPORTED_MODULE_0__.ssrUtils.setupComponent,
    renderComponentRoot = vue__WEBPACK_IMPORTED_MODULE_0__.ssrUtils.renderComponentRoot,
    normalizeVNode = vue__WEBPACK_IMPORTED_MODULE_0__.ssrUtils.normalizeVNode; // Each component has a buffer array.
...
function createBuffer() {
  ...
  return {
    ...
    push: function push(item) {
      var isStringItem = (0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isString)(item);
      ...
      if ((0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isPromise)(item) || (0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isArray)(item) && item.hasAsync) {
...
function renderComponentVNode(vnode) {
  ...
  var hasAsyncSetup = (0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isPromise)(res);
...
function renderComponentSubTree(instance, slotScopeId) {
  ...
  if ((0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isFunction)(comp)) {
    var root = renderComponentRoot(instance); // #5817 scope ID attrs not falling through if functional component doesn't
    // have props
    ...
    if ((!instance.render || instance.render === _vue_shared__WEBPACK_IMPORTED_MODULE_1__.NOOP) && !instance.ssrRender && !comp.ssrRender && (0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isString)(comp.template)) {
    ...
    if (ssrRender) {
      ...
      var prev = setCurrentRenderingInstance(instance);
      ssrRender(instance.proxy, push, instance, attrs, // compiler-optimized bindings
      instance.props, instance.setupState, instance.data, instance.ctx);
      setCurrentRenderingInstance(prev);
    } else if (instance.render && instance.render !== _vue_shared__WEBPACK_IMPORTED_MODULE_1__.NOOP) {
      renderVNode(push, instance.subTree = renderComponentRoot(instance), instance, slotScopeId);
    } else {
      var componentName = comp.name || comp.__file || "<Anonymous>";
      (0,vue__WEBPACK_IMPORTED_MODULE_0__.warn)("Component ".concat(componentName, " is missing template or render function."));
      push("<!---->");
    }
  }
...
function renderVNode(push, vnode, parentComponent, slotScopeId) {
  ...
  switch (type) {
    case vue__WEBPACK_IMPORTED_MODULE_0__.Text:
      push((0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.escapeHtml)(children));
      break;

    case vue__WEBPACK_IMPORTED_MODULE_0__.Comment:
      push(children ? "<!--".concat((0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.escapeHtmlComment)(children), "-->") : "<!---->");
      break;

    case vue__WEBPACK_IMPORTED_MODULE_0__.Static:
      push(children);
      break;
    ...
    default:
      ...
      /* SUSPENSE */
        ...
        (0,vue__WEBPACK_IMPORTED_MODULE_0__.warn)('[@vue/server-renderer] Invalid VNode type:', type, "(".concat(_typeof(type), ")"));
      }
...
function renderElementVNode(push, vnode, parentComponent, slotScopeId) {
  ...
  if (!(0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isVoidTag)(tag)) {
    ...
    if (props) {
      if (props.innerHTML) {
        ...
        hasChildrenOverride = true;
        push((0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.escapeHtml)(props.textContent));
      } else if (tag === 'textarea' && props.value) {
        hasChildrenOverride = true;
        push((0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.escapeHtml)(props.value));
      }
    }
...
function applySSRDirectives(vnode, rawProps, dirs) {
  ...
  return vue__WEBPACK_IMPORTED_MODULE_0__.mergeProps.apply(void 0, [rawProps || {}].concat(toMerge));
}
...
function renderTeleportVNode(push, vnode, parentComponent, slotScopeId) {
  ...
  if (!target) {
    if (!disabled) {
      (0,vue__WEBPACK_IMPORTED_MODULE_0__.warn)("[@vue/server-renderer] Teleport is missing target prop.");
    }
  ...
  if (!(0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isString)(target)) {
    (0,vue__WEBPACK_IMPORTED_MODULE_0__.warn)("[@vue/server-renderer] Teleport target must be a query selector string.");
    return [];
  }
...
var isVNode = vue__WEBPACK_IMPORTED_MODULE_0__.ssrUtils.isVNode;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (!(0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isPromise)(item)) {
              _context2.next = 9;
              break;
            }
          ...
          case 9:
            if (!(0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isString)(item)) {
              _context2.next = 13;
              break;
            }
...
function renderToString(_x2) {
  return _renderToString.apply(this, arguments);
}

function _renderToString() {
  _renderToString = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(input) {
    var context,
        vnode,
        buffer,
        result,
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return _context3.abrupt("return", renderToString((0,vue__WEBPACK_IMPORTED_MODULE_0__.createApp)({
          ...
          case 3:
            // rendering an app
            vnode = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(input._component, input._props);
            vnode.appContext = input._context; // provide the ssr context to the tree

            input.provide(vue__WEBPACK_IMPORTED_MODULE_0__.ssrContextKey, context);
            _context3.next = 8;
...
var isVNode$1 = vue__WEBPACK_IMPORTED_MODULE_0__.ssrUtils.isVNode;

function unrollBuffer$1(_x4, _x5) {
  return _unrollBuffer$.apply(this, arguments);
}

function _unrollBuffer$() {
  _unrollBuffer$ = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(buffer, stream) {
    var i, item;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 12:
            _context5.next = 14;
            return unrollBuffer$1(item, stream);
...
function renderToSimpleStream(input, context, stream) {
  if (isVNode$1(input)) {
    ...
    return renderToSimpleStream((0,vue__WEBPACK_IMPORTED_MODULE_0__.createApp)({
      render: function render() {
        return input;
      }
    }), context, stream);
  ...
  var vnode = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(input._component, input._props);
  vnode.appContext = input._context; // provide the ssr context to the tree

  input.provide(vue__WEBPACK_IMPORTED_MODULE_0__.ssrContextKey, context);
  Promise.resolve(renderComponentVNode(vnode)).then(function (buffer) {
    return unrollBuffer$1(buffer, stream);
  }).then(function () {
    return resolveTeleports(context);
  }).then(function () {
...
function pipeToWebWritable(input) {
  ...
  var encoder = new TextEncoder(); // #4287 CloudFlare workers do not implement `ready` property

  var hasReady = false;

  try {
    hasReady = (0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isPromise)(writer.ready);
  } catch (e) {}
...
function ssrRenderComponent(comp) {
  ...
  return renderComponentVNode((0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(comp, props, children), parentComponent, slotScopeId);
}
...
function ssrRenderSlotInner(slots, slotName, slotProps, fallbackRenderFn, push, parentComponent, slotScopeId) {
  ...
  if (slotFn) {
    ...
    if ((0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isArray)(ret)) {
      // normal slot
...
function ssrInterpolate(value) {
  return (0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.escapeHtml)((0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.toDisplayString)(value));
}
...
function ssrRenderSuspense(_x6, _x7) {
  return _ssrRenderSuspense.apply(this, arguments);
}

function _ssrRenderSuspense() {
  _ssrRenderSuspense = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(push, _ref3) {
    var renderContent;
...
var ssrLooseEqual = _vue_shared__WEBPACK_IMPORTED_MODULE_1__.looseEqual;

function ssrLooseContain(arr, value) {
  return (0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.looseIndexOf)(arr, value) > -1;
...
function ssrRenderDynamicModel(type, model, value) {
  switch (type) {
    case 'radio':
      return (0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.looseEqual)(model, value) ? ' checked' : '';

    case 'checkbox':
      return ((0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isArray)(model) ? ssrLooseContain(model, value) : model) ? ' checked' : '';
...
function ssrGetDynamicModelProps() {
  ...
  switch (type) {
    case 'radio':
      return (0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.looseEqual)(model, value) ? {
        checked: true
      } : null;

    case 'checkbox':
      return ((0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isArray)(model) ? ssrLooseContain(model, value) : model) ? {
        checked: true
      } : null;
...
(0,vue__WEBPACK_IMPORTED_MODULE_0__.initDirectivesForSSR)();
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  component: _HelloWorld_vue__WEBPACK_IMPORTED_MODULE_0__["default"],
  data: function data() {
    return {
      title: 'Hello World'
    };
...
/* harmony export */ });
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! vue */ "./node_modules/vue/index.mjs");
/* harmony import */ var vue_server_renderer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! vue/server-renderer */ "./node_modules/vue/server-renderer/index.mjs");


function ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  var _component_HelloWorld = (0,vue__WEBPACK_IMPORTED_MODULE_0__.resolveComponent)("HelloWorld");

  _push("<!--[--><h2>\u6211\u662FVue\u6E32\u67D3\u51FA\u6765\u7684</h2><h2>".concat((0,vue_server_renderer__WEBPACK_IMPORTED_MODULE_1__.ssrInterpolate)($data.title), "</h2>"));

  _push((0,vue_server_renderer__WEBPACK_IMPORTED_MODULE_1__.ssrRenderComponent)(_component_HelloWorld, null, null, _parent));
...
function ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push("<h2".concat((0,vue_server_renderer__WEBPACK_IMPORTED_MODULE_0__.ssrRenderAttrs)(_attrs), ">Hello World \u7EC4\u4EF6</h2>"));
}
...
/* harmony import */ var E_Project_study_Vue3_TS_learn_webpack_06_basic_webpack_vue_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");




;
const __exports__ = /*#__PURE__*/(0,E_Project_study_Vue3_TS_learn_webpack_06_basic_webpack_vue_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_App_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['ssrRender',_App_vue_vue_type_template_id_5e019a2f__WEBPACK_IMPORTED_MODULE_0__.ssrRender],['__file',"src/vue/App.vue"]])
...
;
const __exports__ = /*#__PURE__*/(0,E_Project_study_Vue3_TS_learn_webpack_06_basic_webpack_vue_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_HelloWorld_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['ssrRender',_HelloWorld_vue_vue_type_template_id_7d22bc7c__WEBPACK_IMPORTED_MODULE_0__.ssrRender],['__file',"src/vue/HelloWorld.vue"]])
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ssrRender": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_dist_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_dist_index_js_ruleSet_1_rules_13_use_0_App_vue_vue_type_template_id_5e019a2f__WEBPACK_IMPORTED_MODULE_0__.ssrRender)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ssrRender": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_dist_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_dist_index_js_ruleSet_1_rules_13_use_0_HelloWorld_vue_vue_type_template_id_7d22bc7c__WEBPACK_IMPORTED_MODULE_0__.ssrRender)
/* harmony export */ });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.js */ "./node_modules/vue/index.js");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "pipeToNodeWritable": () => (/* reexport safe */ _vue_server_renderer__WEBPACK_IMPORTED_MODULE_0__.pipeToNodeWritable),
/* harmony export */   "pipeToWebWritable": () => (/* reexport safe */ _vue_server_renderer__WEBPACK_IMPORTED_MODULE_0__.pipeToWebWritable),
/* harmony export */   "renderToNodeStream": () => (/* reexport safe */ _vue_server_renderer__WEBPACK_IMPORTED_MODULE_0__.renderToNodeStream),
/* harmony export */   "renderToSimpleStream": () => (/* reexport safe */ _vue_server_renderer__WEBPACK_IMPORTED_MODULE_0__.renderToSimpleStream),
/* harmony export */   "renderToStream": () => (/* reexport safe */ _vue_server_renderer__WEBPACK_IMPORTED_MODULE_0__.renderToStream),
/* harmony export */   "renderToString": () => (/* reexport safe */ _vue_server_renderer__WEBPACK_IMPORTED_MODULE_0__.renderToString),
/* harmony export */   "renderToWebStream": () => (/* reexport safe */ _vue_server_renderer__WEBPACK_IMPORTED_MODULE_0__.renderToWebStream),
/* harmony export */   "ssrGetDirectiveProps": () => (/* reexport safe */ _vue_server_renderer__WEBPACK_IMPORTED_MODULE_0__.ssrGetDirectiveProps),
/* harmony export */   "ssrGetDynamicModelProps": () => (/* reexport safe */ _vue_server_renderer__WEBPACK_IMPORTED_MODULE_0__.ssrGetDynamicModelProps),
/* harmony export */   "ssrIncludeBooleanAttr": () => (/* reexport safe */ _vue_server_renderer__WEBPACK_IMPORTED_MODULE_0__.ssrIncludeBooleanAttr),
/* harmony export */   "ssrInterpolate": () => (/* reexport safe */ _vue_server_renderer__WEBPACK_IMPORTED_MODULE_0__.ssrInterpolate),
/* harmony export */   "ssrLooseContain": () => (/* reexport safe */ _vue_server_renderer__WEBPACK_IMPORTED_MODULE_0__.ssrLooseContain),
/* harmony export */   "ssrLooseEqual": () => (/* reexport safe */ _vue_server_renderer__WEBPACK_IMPORTED_MODULE_0__.ssrLooseEqual),
/* harmony export */   "ssrRenderAttr": () => (/* reexport safe */ _vue_server_renderer__WEBPACK_IMPORTED_MODULE_0__.ssrRenderAttr),
/* harmony export */   "ssrRenderAttrs": () => (/* reexport safe */ _vue_server_renderer__WEBPACK_IMPORTED_MODULE_0__.ssrRenderAttrs),
/* harmony export */   "ssrRenderClass": () => (/* reexport safe */ _vue_server_renderer__WEBPACK_IMPORTED_MODULE_0__.ssrRenderClass),
/* harmony export */   "ssrRenderComponent": () => (/* reexport safe */ _vue_server_renderer__WEBPACK_IMPORTED_MODULE_0__.ssrRenderComponent),
/* harmony export */   "ssrRenderDynamicAttr": () => (/* reexport safe */ _vue_server_renderer__WEBPACK_IMPORTED_MODULE_0__.ssrRenderDynamicAttr),
/* harmony export */   "ssrRenderDynamicModel": () => (/* reexport safe */ _vue_server_renderer__WEBPACK_IMPORTED_MODULE_0__.ssrRenderDynamicModel),
/* harmony export */   "ssrRenderList": () => (/* reexport safe */ _vue_server_renderer__WEBPACK_IMPORTED_MODULE_0__.ssrRenderList),
/* harmony export */   "ssrRenderSlot": () => (/* reexport safe */ _vue_server_renderer__WEBPACK_IMPORTED_MODULE_0__.ssrRenderSlot),
/* harmony export */   "ssrRenderSlotInner": () => (/* reexport safe */ _vue_server_renderer__WEBPACK_IMPORTED_MODULE_0__.ssrRenderSlotInner),
/* harmony export */   "ssrRenderStyle": () => (/* reexport safe */ _vue_server_renderer__WEBPACK_IMPORTED_MODULE_0__.ssrRenderStyle),
/* harmony export */   "ssrRenderSuspense": () => (/* reexport safe */ _vue_server_renderer__WEBPACK_IMPORTED_MODULE_0__.ssrRenderSuspense),
/* harmony export */   "ssrRenderTeleport": () => (/* reexport safe */ _vue_server_renderer__WEBPACK_IMPORTED_MODULE_0__.ssrRenderTeleport),
/* harmony export */   "ssrRenderVNode": () => (/* reexport safe */ _vue_server_renderer__WEBPACK_IMPORTED_MODULE_0__.ssrRenderVNode)
/* harmony export */ });
/* harmony import */ var _vue_server_renderer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @vue/server-renderer */ "./node_modules/@vue/server-renderer/dist/server-renderer.esm-bundler.js");
...
console.log(priceFormat()); // vue 代码
// const app = createApp({
...
var app = (0,vue_dist_vue_esm_bundler__WEBPACK_IMPORTED_MODULE_1__.createApp)({
  render: function render() {
    return (0,vue_dist_vue_esm_bundler__WEBPACK_IMPORTED_MODULE_1__.h)(_vue_App_vue__WEBPACK_IMPORTED_MODULE_2__["default"]);
  }
});
app.mount('#app');
})();
